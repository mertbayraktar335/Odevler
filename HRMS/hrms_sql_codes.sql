...
(
    id integer NOT NULL,
    candidates_user_id integer NOT NULL,
    PRIMARY KEY (id)
);
...
(
    id integer NOT NULL,
    activation_code character varying(123) NOT NULL,
...
(
    ...
    lastname character varying(22) NOT NULL,
    PRIMARY KEY (id)
);
...
(
    ...
    web_adress character varying(20) NOT NULL,
    phone_number character varying(15) NOT NULL,
...
CREATE TABLE public."job-titles"
(
    id integer NOT NULL,
...
ALTER TABLE public.activation_code_candidates
    ADD FOREIGN KEY (candidates_user_id)
